	...
	$.ajax({
	  ...
	  success: function (data, status) {
	    ...
	    function FcreatShow(n){					//创建show对应作品
	    	...
	    	var p = '<div class="Show'+data.data[n].id+' Show"><img src='+preImg+data.data[n].pic+' alt="show'+n+'"><p class="ShowText"><span>'+data.data[n].title+'</span><br/><a href="#" class="editBtn"><img src="./img/administrate/edit.png" alt="edit" class="editBtnImg"></a><a href="#" class="deleteBtn"><img src="./img/administrate/delete.png" alt="delete" class="deleteBtnImg"></a></p></div>'
	    	return p;
	    };
